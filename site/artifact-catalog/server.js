...
const SEED_ARTIFACTS = [
  ...
  // ── B+W ARCHIVAL SCANS ────────────────────────────────────────────────────
  // 36 scanned black-and-white photographs sorted by environmental character
  // into site folders. 34 assigned to locations; 2 archived (climate-incongruent).
  // Source: /90 media/images/b+w scans/. Sort index: b+w-scan-sort-index.md.

  // 001 Tributary Confluence Wet Meadow
  { location_id: '001', title: 'B+W scan: stream with gravel bars, winter', type: 'photograph', period: 'early 20th century', arena_url: null, description: 'Aged print with heavy edge damage and water staining. A stream winds through bare-branch winter landscape. Gravel banks exposed on both sides of a low-gradient channel. Mixed riparian vegetation: conifers behind, bare deciduous at the water margin. Flat alluvial terrain surrounds the channel. The stream width, exposed gravel, and alluvial character match the confluence zone at winter low water. File: TC-scan-001-stream-with-gravel-bars-winter.jpg' },
  { location_id: '001', title: 'B+W scan: stream bend and alluvial banks', type: 'photograph', period: 'early 20th century', arena_url: null, description: 'Companion to the gravel bar photograph, taken from a slightly different angle at the same location. Channel bends through flat terrain. Gravel and sediment banks visible. Bare deciduous trees with conifers at distance. Water level low, exposing the alluvial substrate. Same aging and edge damage as its pair. File: TC-scan-002-stream-bend-and-alluvial-banks.jpg' },
  { location_id: '001', title: 'B+W scan: flat meadow toward distant structures', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Flat, open grass or sedge field extending toward distant farmstead structures. Low overcast sky. Vegetation winter-dormant or early spring. The horizontal character dominates. No enclosing forest visible at the meadow surface. The structures in the middle ground read as habitation within the valley system, visible from the open flood-maintained meadow. File: TC-scan-003-flat-meadow-toward-distant-structures.jpg' },
  { location_id: '001', title: 'B+W scan: flat sedge margin with young trees', type: 'photograph', period: 'early 20th century', arena_url: null, description: 'Flat, low-lying terrain. Dry sedge or grass in the foreground. Young deciduous trees scattered across the middle ground in irregular colonization pattern. Conifer forest line at distance. Transitional character between open meadow and enclosing forest. Faded print with soft tonal range. The pioneer trees advancing from the forest edge match the alder-willow transition zone described at the meadow perimeter. File: TC-scan-004-flat-sedge-margin-with-young-trees.jpg' },
  { location_id: '001', title: 'B+W scan: open ground and cumulus sky', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Very flat, open landscape. Cumulus clouds dominate the upper two-thirds of the frame. Low vegetation at ground level. Transmission towers visible on the horizon. The flat openness and sky dominance carry atmospheric resonance with the confluence meadow\'s exposure to weather, though the scale exceeds the meadow. Contextual rather than site-specific. File: TC-scan-005-possible-open-meadow-and-sky.jpg' },

  // 002 Abandoned Hillside Orchard
  { location_id: '002', title: 'B+W scan: cultivated planting among conifers', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Ornamental landscape: a weeping deciduous tree flanked by upright conifers. Daffodils at ground level. Maintained lawn. The formality exceeds what the orchard clearing would have shown, but the persistence of cultivated vegetation within a conifer framework carries atmospheric value. The deliberate arrangement of planted specimens among the surrounding forest evokes the orchard\'s managed legacy. File: AO-scan-001-possible-cultivated-planting-with-conifers.jpg' },
  { location_id: '002', title: 'B+W scan: worked ground under canopy', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Tilled or recently worked earth in an open clearing, framed by a large deciduous tree canopy overhead. Shrubby and forested margin at the far edge. The combination of altered soil, mature canopy shade, and forest pressing at the margins reads as the orchard clearing\'s cultivated character. The worked ground and the tree above it occupy the same spatial relationship as the orchard floor and its surviving canopy. File: AO-scan-002-worked-ground-under-canopy.jpg' },
  { location_id: '002', title: 'B+W scan: spaced trees on hillslope', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Small trees at semi-regular spacing on a grassy hillslope. Dry grass between them. Mountain or ridge rising in the background through haze. The moderate slope and the tree spacing, inconsistent with natural forest recruitment, read as intentional planting on bench-slope terrain. The environmental character matches the abandoned orchard precisely: persistence of managed spacing, open ground under succession, ridge backdrop above. One of the strongest site matches in the scan collection. File: AO-scan-003-spaced-trees-on-hillslope.jpg' },
  { location_id: '002', title: 'B+W scan: orchard spacing on grassy hillside', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Mature trees at wide, semi-regular intervals on a grassy hillside. The trees have the spreading canopy form of fruit or nut species rather than forest trees. Furrowed or textured ground surface. The orchard spacing is legible across the clearing. The tree arrangement, grassy intervals, and hillside position read as the abandoned orchard\'s described character. Companion to the hillslope scan. File: AO-scan-004-orchard-spacing-on-grassy-hillside.jpg' },

  // 003 Forest Crossing
  { location_id: '003', title: 'B+W scan: rocky stream through forested ravine', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Stream flowing over rocks and boulders in a steep, forested ravine. Dense conifer canopy above. Water moving with energy through a confined, rocky channel. The enclosure is complete on both sides. The rocky substrate, confined channel width, and conifer-forested enclosure match the crossing\'s described physical structure: the seep-fed tributary cutting through glacial till on the western slope. File: FC-scan-001-rocky-stream-through-forested-ravine.jpg' },
  { location_id: '003', title: 'B+W scan: steep drainage through conifers', type: 'photograph', period: '1957', arena_url: null, description: 'Dated AUG 57 on the print. Large waterfall descending through dense conifer forest in a steep-sided ravine. Substantial water volume exceeding the crossing\'s described 1-2 meter stream width. The environmental character resonates with the ravine system\'s drainage energy even though the scale is wrong. Atmospheric rather than site-specific; the waterfall\'s relationship to the surrounding forest has archival value for depicting the drainage corridor\'s character under high-energy conditions. File: FC-scan-002-possible-steep-drainage-through-conifers.jpg' },
  { location_id: '003', title: 'B+W scan: winter trail through snow woods', type: 'photograph', period: '1956', arena_url: null, description: 'Dated MAR 56 on the print. Heavy snow on bare deciduous branches. A path or trail descends through enclosed winter woods. Stone or log features visible at ground level near the bottom of the frame. The enclosed character, the trail through mixed forest, and the ground-level features match the forest crossing\'s approach: the descent through bench forest toward the ravine head in late winter. File: FC-scan-003-winter-trail-through-snow-woods.jpg' },

  // 004 Beaver Meadow
  { location_id: '004', title: 'B+W scan: winter ice at impoundment margin', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Flat frozen surface. Three figures skating. Bare deciduous trees at left margin, dense conifer forest behind. Snow on banks. The flat expanse of ice bounded by forest on both sides suggests a frozen water body in a confined valley corridor. The human presence, people using the frozen surface, suggests the kind of seasonal access the impoundment would permit when winter freezes the pond solid. File: BM-scan-001-winter-ice-at-impoundment-margin.jpg' },
  { location_id: '004', title: 'B+W scan: dense shrub margin in summer', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Two figures immersed in extremely dense deciduous shrub growth. Multi-stemmed, tangled vegetation at and above head height. Full summer leaf. The density and multi-stemmed character are consistent with the vigorous willow and alder colonization at the impoundment\'s margins, the early-successional shrub establishing in light-rich, organically enriched conditions where forest formerly stood. The people provide scale for the vegetation height. File: BM-scan-002-possible-dense-shrub-margin-in-summer.jpg' },
  { location_id: '004', title: 'B+W scan: still water with young margin trees', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Still water body with dense mixed forest behind. Young deciduous trees establishing at the water\'s edge. Flat water surface. The calm, contained quality of the water within a forested corridor matches the impoundment\'s character: open water backed by forest, with pioneer vegetation at the transitional margin. A utility pole is visible but does not dominate the composition. File: BM-scan-003-still-water-with-young-margin-trees.jpg' },
  { location_id: '004', title: 'B+W scan: still water and reflected forest', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Wide stream or river with a leaning deciduous tree extending over still water. Dense canopy reflected in the water surface. The reflection is detailed and continuous. The calm water reflecting surrounding forest canopy is one of the beaver meadow\'s most characteristic atmospheric signatures. The leaning and partially fallen trunk reads as the standing dead timber at the impoundment margin. Aged print with warm tonal shift. File: BM-scan-004-still-water-and-reflected-forest.jpg' },

  // 005 Stone Foundation Clearing
  { location_id: '005', title: 'B+W scan: stone steps and cultivated ground', type: 'photograph', period: 'early-to-mid 20th century', arena_url: null, description: 'Woman seated on stone steps in a garden setting. Vegetation growing around and over the stone, both cultivated and self-seeded. The stone construction is being incorporated into the surrounding growth. The combination of worked stone and advancing plant life echoes the stone foundation\'s defining condition: cultural residue being absorbed by ecological process. File: SF-scan-001-stone-steps-and-cultivated-ground.jpg' },
  { location_id: '005', title: 'B+W scan: cabin among conifers', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Woman on the porch of a shingled wood cabin. Mature conifers behind. Wicker furniture, vine-covered post, stone border at the base. The built structure among conifers represents the habitation condition that the stone foundation records in its aftermath: the organic structure that preceded the stone-only remnant. The stone border at the base echoes the surviving foundation courses. File: SF-scan-002-cabin-among-conifers.jpg' },
  { location_id: '005', title: 'B+W scan: winter conifers and structure', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Tall, straight conifer trunks in snow. A small structure or cabin visible at the right edge of the frame. Long shadows on the snow surface. The structure glimpsed through winter conifer forest reads as the bench forest condition: former habitation visible as a small presence within the larger forest matrix. The snow conditions make the clearing and the structure legible against the surrounding canopy. File: SF-scan-003-winter-conifers-and-structure.jpg' },
  { location_id: '005', title: 'B+W scan: collapsing structure in overgrown field', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Dilapidated wooden shed or outbuilding in advanced collapse. Overgrown field surrounds it. Bare deciduous trees at margins. Dry winter grass. The structure is losing its form to time and weather. The organic structure decomposes while the clearing it created persists, slowly narrowed by succession. This is the stone foundation clearing\'s central condition expressed through its earlier phase: a built presence returning to the ground. The strongest single-image evocation of reclamation in the scan collection. File: SF-scan-004-collapsing-structure-in-overgrown-field.jpg' },
  { location_id: '005', title: 'B+W scan: clearing with succession from margins', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Open grassy clearing on a hillside. Young trees and shrubs establishing from the margins. Forested hillside beyond. A gap through the trees reveals a view downslope toward distant terrain. The clearing is being actively compressed by advancing vegetation. The pioneer growth at the margins and the downslope gap match the stone foundation clearing\'s bench position, where succession presses inward and the valley floor is occasionally visible below. File: SF-scan-005-clearing-with-succession-from-margins.jpg' },
  { location_id: '005', title: 'B+W scan: view through pines downslope', type: 'photograph', period: '1966', arena_url: null, description: 'Dated APR 66 on the print. View through mature pine trunks downslope toward buildings and a road below. Dense understory shrubs. The perspective is from an elevated, forested position looking down. The spatial relationship, a bench position in the forest with the valley and its contents partly visible through gaps in the canopy, matches the described approach to the stone foundation clearing. April conditions suggest early spring before full leaf. File: SF-scan-006-possible-view-through-pines-downslope.jpg' },

  // 006 Headwater Spring
  { location_id: '006', title: 'B+W scan: enclosed verdant path', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Dense vegetation enclosing a narrow path. Ferns, broad-leaved plants, overhanging canopy. Deeply enclosed with dappled light through thick cover. Moisture-rich character throughout. The vegetation is climate-incongruent with the watershed, but the environmental character resonates with the headwater spring: deep enclosure, intimate scale, proximity to saturated ground, dense ground-level growth, and the absence of any view beyond the immediate surroundings. Atmospheric rather than documentary. File: HS-scan-001-possible-enclosed-verdant-path.jpg' },

  // 007 Ridge Overlook
  { location_id: '007', title: 'B+W scan: couple on exposed ridge grass', type: 'photograph', period: '1930s', arena_url: null, description: 'Two figures standing on an exposed grassy hilltop. Sky dominates the frame. Wind-moved grass. No trees in the immediate vicinity. The elevation and exposure are the primary conditions. Period estimated from clothing. The wind in the grass and the sky\'s dominance express the ridge position\'s defining qualities: exposure, height, and the absence of canopy. File: RO-scan-001-couple-on-exposed-ridge-grass.jpg' },
  { location_id: '007', title: 'B+W scan: conifer canopy toward distant ridge', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'View through conifer treetops toward a distant mountain or ridge partly obscured by haze. The viewer is at elevation, looking through the upper canopy toward terrain beyond. The transition zone on the ascent to the overlook: still within the conifer canopy but with the distant ridge beginning to appear through gaps. Scratches on the print surface. File: RO-scan-002-conifer-canopy-toward-distant-ridge.jpg' },
  { location_id: '007', title: 'B+W scan: valley view from fenced hillside', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Rolling pastoral landscape from an elevated position. Fenced fields, scattered pine trees, distant hills and ridges with forested slopes. Farm structures in the middle distance. The perspective reads the landscape as a system of relationships: foreground slope descending to valley floor, the floor extending toward distant terrain. The structural understanding of landscape-as-system matches the overlook\'s orientation function. File: RO-scan-003-valley-view-from-fenced-hillside.jpg' },
  { location_id: '007', title: 'B+W scan: mountain valley from upper slope', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Mountain valley viewed from high on a slope. Sparse young trees and scrub in the foreground. Ridges descending into the valley below. Cloud or fog partially obscuring a distant peak. The scrubby foreground vegetation, sparse trees on thin soil, and cloud-obscured ridge suggest the upper slope approach to the overlook position, near the krummholz transition zone. File: RO-scan-004-mountain-valley-from-upper-slope.jpg' },
  { location_id: '007', title: 'B+W scan: valley and ridges from stone shelf', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Panoramic valley view from elevation. Stone wall or bedrock shelf in the foreground. Lake or river in the middle distance. Layered mountains and ridges receding into atmospheric haze. The stone shelf echoes the exposed bedrock of the overlook position. The layered ridges, water corridor below, and atmospheric recession express exactly the structural visibility the ridge provides: the drainage system\'s logic readable from elevation. The strongest ridge match in the scan collection. File: RO-scan-005-valley-and-ridges-from-stone-shelf.jpg' },
  { location_id: '007', title: 'B+W scan: flat horizon and sky', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Flat landscape, large sky with cumulus clouds. Transmission towers on the horizon. The sky dominance and uninterrupted horizon carry atmospheric resonance with the ridge\'s exposure condition, though the terrain is flat rather than elevated. The big sky and distant horizon express what the overlook experiences from above. Contextual rather than site-specific. File: RO-scan-006-possible-flat-horizon-and-sky.jpg' },
  { location_id: '007', title: 'B+W scan: exposed boulder among conifers', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Large exposed boulder or rock outcrop with conifer forest behind. Bare ground around the rock. Clear sky visible above. Light-colored, weathered surface. The bedrock exposure among conifers matches the ridge\'s physical structure: the Precambrian gneiss shelf exposed by frost action and wind scouring, with surrounding conifers pressing close but unable to establish on the bare rock surface. File: RO-scan-007-exposed-boulder-among-conifers.jpg' },
  { location_id: '007', title: 'B+W scan: valley view through conifers from height', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'View from elevation through large conifers into a deep valley. Distant mountains and ridges beyond. A waterfall or light-colored feature visible in the valley below. The structural reading from the ridge down into the valley: the drainage system visible as a corridor descending between forested slopes, distant ridges providing the containment arc. One of the strongest overlook matches. File: RO-scan-008-valley-view-through-conifers-from-height.jpg' },
  { location_id: '007', title: 'B+W scan: high-elevation conifers with snow', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'High-elevation conifer forest with persistent snow patches. Ridgeline with exposed rock faces and dense spruce. Subalpine character. Snow persistence and rock exposure suggest elevation near or above the tree limit. The upper watershed environment where the ridge sheds its forest cover and exposes the underlying bedrock. File: RO-scan-009-high-elevation-conifers-with-snow.jpg' },
  { location_id: '007', title: 'B+W scan: dead trunk at ridgetop with haze', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Ridgetop or high slope. Dead standing trunk prominent and bare, projecting against the open sky. Dense low vegetation surrounding it. View below and beyond dissolves into atmospheric haze. The dead trunk at an exposed position, the view downward through haze, and the dense low vegetation suggest the krummholz transition zone at the upper tree limit. The wind-shaped character of the surrounding growth is legible. File: RO-scan-010-dead-trunk-at-ridgetop-with-haze.jpg' },
  { location_id: '007', title: 'B+W scan: ridge silhouette at dusk', type: 'photograph', period: 'mid-20th century', arena_url: null, description: 'Silhouette of a ridge and scattered trees against a dusk or dawn sky. Foreground in deep shadow. Ridge profile readable as a line against layered clouds. The ridge at the boundary between day and night. The silhouetted profile and scattered trees express the exposure condition and the relationship to the sky. Atmospheric rather than documentary, but carries the ridge position\'s defining visual quality: the horizon line, the sky above, the watershed below. File: RO-scan-011-ridge-silhouette-at-dusk.jpg' },

  // ── DOMESTIC / PERSONAL / COMMUNITY LAYER ─────────────────────────────────
  // 002 Abandoned Hillside Orchard
  { location_id: '002', title: 'Recipe card: apple butter', type: 'recipe card', period: 'mid-20th century', arena_url: null, description: 'Handwritten recipe card, stained and softened at the edges, for "Mother\'s Apple Butter." Neat cursive on a lined index card. Ingredients include McIntosh apples, brown sugar, cinnamon, cloves. A note in different handwriting at the bottom: "Use windfalls — just cut out the bad spots." Ring stain from a mug.' },
  { location_id: '002', title: 'Newspaper clipping: Halderson orchard takes top honors', type: 'newspaper clipping', period: '1950s', arena_url: null, description: 'Clipping from the Northing County Register. Headline: "Halderson Orchard Takes Top Honors at County Fair." Short article with a small black-and-white photograph of a man next to a display table of apples. Yellowed newsprint, edges torn unevenly. A few words circled in pencil.' },
  { location_id: '002', title: 'Letter: leaving the orchard', type: 'correspondence', period: '1961', arena_url: null, description: 'Handwritten letter on thin ruled paper, dated Nov. 3, 1961. From E. to "Dear Helen." Describes the difficulty of keeping the orchard going alone after a death. Lower rows unpruned for two years. Deer getting worse. Ends: "I don\'t think I can do another winter up here by myself." Blue ballpoint, slightly smeared.' },
  { location_id: '002', title: 'Child\'s drawing: picking apples at grandpa\'s', type: 'child\'s drawing', period: 'undated', arena_url: null, description: 'Bright crayon drawing on white paper. A large apple tree with an oversized green canopy full of red circles. Yellow sun in the corner. A stick-figure person reaching up. Written at the top in wobbly letters: "Picking aples at Grampas." Vivid, saturated colors. Tape marks at the top corners.' },
  { location_id: '002', title: 'B&W photograph: harvest day', type: 'photograph', period: '1947', arena_url: null, description: 'Black-and-white photograph with white border. Three people in the orchard with bushel baskets. Mid-autumn light through half-bare trees. A wooden ladder against a trunk in the background. Slightly out of focus — candid, not posed. Handwritten on the border: "Oct. \'47."' },
  { location_id: '002', title: 'Modern photograph: rusted pruning saw', type: 'found object photograph', period: 'contemporary', arena_url: null, description: 'Modern color photograph of a rusted hand pruning saw lying on fallen leaves and moss. Wooden handle cracked and weathered to silver-gray. Blade pitted but teeth visible. Found at the orchard margin where forest is reclaiming the upper rows. Clean documentary style.' },

  // 004 Beaver Meadow
  { location_id: '004', title: 'Naturalist journal: spring waterbirds', type: 'naturalist notebook', period: 'mid-20th century', arena_url: null, description: 'Colorful naturalist field journal page with watercolor and ink. Four waterfowl in spring plumage: wood ducks in vivid greens and purples, a mallard, and a hooded merganser. Each labeled with species name and date. Loose, confident brushwork. Margin note: "Arrived together — 4/12. Pair of woodies already nesting?"' },
  { location_id: '004', title: 'Child\'s drawing: the beaver who built a city', type: 'child\'s drawing', period: 'undated', arena_url: null, description: 'Bright colored-pencil drawing on blue construction paper. A large brown beaver with exaggerated orange teeth and flat tail, sitting on sticks in water. Blue wavy lines for pond. Green reflected trees. The beaver is smiling. Written in marker: "The Beaver Who Built a City by Jamie, Grade 2." Gold star sticker.' },
  { location_id: '004', title: 'Newspaper clipping: beaver dam blamed for flooding', type: 'newspaper clipping', period: '1987', arena_url: null, description: 'Clipping from the Northing County Register, 1987. Headline: "Beaver Dam Blamed for Meadow Brook Flooding." Article about expanding beaver activity raising water levels, flooding a section of old hay road. Grainy black-and-white photo of water across a dirt track. Someone has written in the margin: "Good for them."' },
  { location_id: '004', title: 'Modern photograph: vintage muskrat trap', type: 'found object photograph', period: 'contemporary', arena_url: null, description: 'Modern color photograph of a vintage steel muskrat trap, closed, resting on a weathered dock plank at the pond edge. Rusted dark orange-brown, chain still attached. Cattail stalks and pond water in soft background. Late afternoon light.' },
  { location_id: '004', title: 'School science poster: life in a beaver pond', type: 'schoolchild nature project', period: '2000s', arena_url: null, description: 'Child\'s science poster on white posterboard. Title in block letters: "LIFE IN A BEAVER POND." Colorful hand-drawn sections: tadpoles, dragonfly nymphs, water striders, a painted turtle, cattails, and a cross-section of a beaver lodge. Some sections have small photographs glued on. Rubric sticker: "A — Excellent work!"' },

  // 003 Forest Crossing
  { location_id: '003', title: 'Newspaper clipping: spring runoff takes out crossing bridge', type: 'newspaper clipping', period: '1974', arena_url: null, description: 'Clipping from the Northing County Register, spring 1974. Headline: "Spring Runoff Takes Out Crossing Bridge." Crossing impassable for two weeks. Local resident quoted: "That\'s the third time since I\'ve been here." Text only, no photograph. Adjacent hardware store ad. Yellowed newsprint.' },
  { location_id: '003', title: 'Modern photograph: hand-forged iron spikes', type: 'found object photograph', period: 'contemporary', arena_url: null, description: 'Modern color photograph of three hand-forged iron spikes on a flat piece of moss-covered rock. Heavily oxidized dark brown-black, square heads, different lengths. Found embedded in a streamside hemlock — remnants of an old footbridge or log structure. Natural forest light.' },
  { location_id: '003', title: 'Letter: trail directions to the crossing', type: 'correspondence', period: 'mid-20th century', arena_url: null, description: 'Handwritten letter on personal stationery giving directions to the crossing: "Follow the old road past the maple stand until you hear the water. Stay left where the path splits — the right fork dead-ends at a blowdown. The crossing is passable in late summer if you don\'t mind wet boots." Signed "R." Black ink.' },
  { location_id: '003', title: 'Child\'s watercolor: the secret crossing', type: 'child\'s drawing', period: 'undated', arena_url: null, description: 'Watercolor painting by a child (age 8-10). A stream between dark green trees with large colorful rocks in the water. A small red bird on a branch. Water in bold blues and whites. A small figure on the bank. At the bottom: "The Secret Crossing, by Anna M." Vivid greens, blues, and earth tones.' },

  // 006 Headwater Spring
  { location_id: '006', title: 'Recipe note: spring tonic', type: 'recipe card', period: 'early 20th century', arena_url: null, description: 'Handwritten recipe on a small piece of paper. Titled "Spring Tonic — April." Fresh watercress from the spring margin, dandelion greens, a little vinegar, honey. A note: "Water from 006 is always cold enough. Bring a jar." Pencil on lined paper, slightly crumpled.' },
  { location_id: '006', title: 'Naturalist journal: spring margin insects', type: 'naturalist notebook', period: 'mid-20th century', arena_url: null, description: 'Colorful naturalist field journal spread (two pages). Detailed watercolor illustrations of insects: stonefly adult, caddisfly larva in its case, water penny beetle, crane fly. Each labeled with common and Latin names. Water temperature and substrate notes on the right page. Bright, precise watercolors on cream paper.' },
  { location_id: '006', title: 'Child\'s drawing: the magic spring', type: 'child\'s drawing', period: 'undated', arena_url: null, description: 'Bright crayon drawing on white paper. Circular blue pool with wavy lines showing water movement. Green plants around the edge. Colorful circles in the water (stones through clear water). A frog on a rock. Arrows showing water flowing out into a stream. Title: "The Magic Spring." Teacher\'s comment in red: "Beautiful! Where is this?"' },
  { location_id: '006', title: 'Modern photograph: stoneware jug at spring', type: 'found object photograph', period: 'contemporary', arena_url: null, description: 'Modern color photograph of a salt-glazed stoneware jug, about 1-gallon size, in dappled forest light on mossy ground near the spring. Cobalt blue "2" painted on the front. Chipped at the rim. Probably early 20th century. Found half-buried in leaf litter. Shallow depth of field, forest floor backdrop.' },
  { location_id: '006', title: 'School report: where does our water come from', type: 'schoolchild nature project', period: '1990s', arena_url: null, description: 'Middle school student report on lined paper. Title: "Where Does Our Water Come From? A Report on Groundwater and Springs." Hand-drawn water cycle diagram colored with colored pencil. Mentions visiting "the spring on the upper bench" during a class field trip. Teacher\'s grade in red: "B+ Good diagrams!"' },

  // 007 Ridge Overlook
  { location_id: '007', title: 'Yearbook page: class of 1958', type: 'yearbook page', period: '1958', arena_url: null, description: 'Page from a high school yearbook. "Northing Regional High School — Class of 1958." Grid of small black-and-white portrait photographs, roughly 20 faces. Names below each. Boys in jackets and ties, girls with period hairstyles. One photo has a small heart drawn around it in pencil. Facing page: candid of students on a ridge, captioned "Senior class hike — Overlook Trail, May 1958."' },
  { location_id: '007', title: 'Letter: describing the view to Margaret', type: 'correspondence', period: '1932', arena_url: null, description: 'Handwritten letter on cream stationery, dated August 14, 1932. Written to "My dear Margaret." Describes the valley spread out below, patchwork of meadow and forest, stream catching light. Mentions counting four farm clearings visible from above. "The air is different up here — you can hear nothing at all except wind." Dried wildflower pressed inside the fold.' },
  { location_id: '007', title: 'Child\'s painting: view from the top', type: 'child\'s drawing', period: 'undated', arena_url: null, description: 'Bright, bold tempera or poster paint on large paper. Wide landscape view from a high point: exaggerated green and blue hill curves, a bright blue river winding through the middle, small colored squares for fields. Huge yellow sun and white clouds. Horizon at the top. Unself-conscious and joyful. Labeled: "View From the Top."' },
  { location_id: '007', title: 'Newspaper clipping: ridge lookout station manned for fire season', type: 'newspaper clipping', period: '1943', arena_url: null, description: 'Clipping from the Northing County Register, 1943. Headline: "Ridge Lookout Station Manned for Fire Season." Article about a fire watcher on the ridge for summer fire spotting. Mentions 360-degree view and logbook. Small grainy photograph of a wooden platform on exposed ridge. "Mrs. Willard packed him a lunch each morning for the climb."' },
  { location_id: '007', title: 'Color photograph: hikers at the overlook, 1973', type: 'photograph', period: '1973', arena_url: null, description: 'Color photograph, slightly faded, with warm 1970s Kodacolor cast. Two hikers sitting on exposed rock at the ridge overlook, backpacks beside them, looking out at the valley. The woman is pointing at something in the distance. Autumn foliage below. Bell-bottom trousers. White border with processing stamp: "OCT 73."' },

  // 005 Stone Foundation Clearing
  { location_id: '005', title: 'Recipe: rhubarb pie from the garden patch', type: 'recipe card', period: 'early 20th century', arena_url: null, description: 'Handwritten recipe on the back of an envelope, in faded pencil. "Rhubarb Pie — from the garden patch." Practical, no-nonsense hand. A note: "Crust recipe on the blue card in the tin." Envelope addressed to Mrs. J. Halderson, Northing Township, with a 3-cent stamp. Flour smudges on the recipe side.' },
  { location_id: '005', title: 'Family note: daily chores', type: 'family note', period: 'early 20th century', arena_url: null, description: 'Small piece of paper torn from a notebook. Chore list in pencil: "Before school: eggs, wood, water. After school: help Papa with the south wall. Supper at 6. DO NOT let the dog in the house." A child has drawn a small dog face at the bottom with a sad expression. Worn soft at the folds.' },
  { location_id: '005', title: 'B&W photograph: family on the porch', type: 'photograph', period: '1920s', arena_url: null, description: 'Black-and-white photograph with scalloped white border. Family of four on the porch of a small stone house — a man, a woman, two children. The house matches the 1898 foundation plans. Forest behind. Everyone in work clothes, squinting. Slightly overexposed. Written on the back: "The place, summer."' },
  { location_id: '005', title: 'Modern photograph: hand-forged door hinge', type: 'found object photograph', period: 'contemporary', arena_url: null, description: 'Modern color photograph of a hand-forged iron door hinge on a stone from the foundation wall. Long strap hinge with a decorative curl at the end. Heavily rusted but form clear. Lichen on the stone. Found in leaf litter inside the foundation perimeter. Sharp modern photography.' },
  { location_id: '005', title: 'School report: the old house in the woods', type: 'schoolchild nature project', period: '1980s', arena_url: null, description: 'Child\'s school report on wide-ruled paper. "The Old House in the Woods — by Thomas P., Grade 4." Describes walking to the clearing with grandfather: "We found the old house where Great-Great-Grandpa Halderson lived. It is just rocks now but you can see where the door was." Small pencil drawing of the foundation. Teacher\'s note: "Wonderful family history! A+"' },
  { location_id: '005', title: 'Newspaper notice: bench parcel for sale', type: 'newspaper clipping', period: '1946', arena_url: null, description: 'Small legal notice from the Northing Township Record, 1946. "For Sale — 50 acres, Bench Parcel, Northing Twp. Stone dwelling (needs roof), barn foundation, cleared garden plot. Spring water. Access by woods road from town highway. Inquire C.H. Sanborn, Northing." Circled in pencil. Adjacent classifieds for hay and a used tractor.' },

  // 001 Tributary Confluence Wet Meadow
  { location_id: '001', title: 'Naturalist journal: fish species at confluence', type: 'naturalist notebook', period: 'mid-20th century', arena_url: null, description: 'Colorful naturalist field journal page showing fish species at the confluence. Detailed watercolor illustrations of brook trout (vivid spots on dark olive, red spots with blue halos, orange fins), slimy sculpin, and blacknose dace. Each at approximate life size. Notes: "Trout holding in deeper water at confluence pool. Sculpins under flat stones. Dace in shallows."' },
  { location_id: '001', title: 'Newspaper clipping: record spring flood strands travelers', type: 'newspaper clipping', period: '1978', arena_url: null, description: 'Clipping from the Northing County Register, April 1978. Headline: "Record Spring Flood Strands Meadow Road Travelers." Snowmelt combined with heavy rain flooded the wet meadow for ten days. A farmer quoted: "Haven\'t seen water that high since \'56." Grainy photo of water across a road with fence posts barely visible. Inset map of affected area.' },
  { location_id: '001', title: 'Child\'s drawing: ducks at the meadow', type: 'child\'s drawing', period: 'undated', arena_url: null, description: 'Bright crayon and marker drawing on construction paper. Four colorful ducks swimming in a line on blue water — each a different color (green, brown, purple stripe, yellow). Cattails on both sides, big blue sky, a small fish jumping. "Ducks at the Medow" written in careful printing, meadow misspelled. Exuberant and vivid.' },
